...
- When the bar is empty and the viewport is 767px or narrower, `.menu-wrapper > .menu-list` and `.cart-wrapper > .cart-list` use `padding-top: var(--_layout---spacing--space-400)`.
